...
class DepartmentApprovalsPage extends StatefulWidget {
  final String department;
  const DepartmentApprovalsPage({super.key, required this.department});

  @override
  State<DepartmentApprovalsPage> createState() => _DepartmentApprovalsPageState();
}

class _DepartmentApprovalsPageState extends State<DepartmentApprovalsPage> {
  int selectedIndex = 1;
  ...
  void loadRequests() {
    requestsFuture = ApiService.getDepartmentRequests(widget.department);
    setState(() {});
  }
  ...
  Future<void> updateStatus(String id, String status) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text("${widget.department} → $status updated"))
    );
    loadRequests();
  }
  ...
  Widget menu(IconData i,String t,int index){
    ...
    return InkWell(
      ...
      child:Container(
        ...
        child:Row(children:[
          Icon(i),SizedBox(width:10),Text(t)
        ])
      ),
    );
  }
  ...
  Widget buildContent(){
    return SingleChildScrollView(
      ...
      child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
        Text("${widget.department} Approvals",
            style:TextStyle(fontSize:28,fontWeight:FontWeight.bold)),
        Text("Review clearance requests",style:TextStyle(color:Colors.black54)),
        const SizedBox(height:30),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    Chip(
                      label: Text(r["status"]),
                      backgroundColor: status(r).withOpacity(.2),
                      labelStyle: TextStyle(color: status(r)),
                    ),
                  ]),
                  ...
                  Row(children: [
                    ...
                    // → APPROVED OR REJECTED = Only View Details
  ...
  Widget stat(String t,String n,{Color color=Colors.black})=>Expanded(child:
    Container(padding:const EdgeInsets.all(20),decoration:box(),
      child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
